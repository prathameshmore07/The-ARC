...
const config: Config = {
  ...
  theme: {
    extend: {
      ...
      animation: {
        'decay-shake': 'decay-shake 0.5s ease-in-out infinite',
      ...
      keyframes: {
        ...
        'pulse-glow': {
          '0%, 100%': { opacity: '1', filter: 'drop-shadow(0 0 8px var(--accent-primary))' },
          '50%': { opacity: '0.5', filter: 'drop-shadow(0 0 2px var(--accent-primary))' },
        },
        glitch: {
